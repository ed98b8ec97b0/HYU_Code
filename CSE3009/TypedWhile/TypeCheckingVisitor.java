...
public class TypeCheckingVisitor extends WhileBaseVisitor<Type> {
  ...
  @Override public Type visitROP_GE(WhileParser.ROP_GEContext ctx) {
    return new VoidType();
  }

  @Override public Type visitROP_LE(WhileParser.ROP_LEContext ctx) {
    return new VoidType();
  }

  @Override public Type visitROP_EQ(WhileParser.ROP_EQContext ctx) {
    return new VoidType();
  }

  @Override public Type visitROP_NEQ(WhileParser.ROP_NEQContext ctx) {
    return new VoidType();
  }
  ...
  @Override public Type visitBOP_XOR(WhileParser.BOP_XORContext ctx) {
    return new VoidType();
  }
