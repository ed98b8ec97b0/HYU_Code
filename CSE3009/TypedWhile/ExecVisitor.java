...
public class ExecVisitor extends WhileBaseVisitor<Integer> {
  ...
  @Override public Integer visitBE_BOP(WhileParser.BE_BOPContext ctx) {
    ...
    switch (visit(ctx.bop())) {
      case 0: return left * right;
      case 1: return left + right;
      default: return Math.abs(left - right);
    }
  }

  @Override public Integer visitBE_ROP(WhileParser.BE_ROPContext ctx) {
    // TODO: GE, LE, EQ, NEQ 추가
    int left = visit(ctx.aexp(0));
    int right = visit(ctx.aexp(1));
    boolean r;
    switch (visit(ctx.rop())) {
      case 0: r = left > right; break;
      case 1: r = left < right; break;
      case 2: r = left >= right; break;
      case 3: r = left <= right; break;
      case 4: r = left == right; break;
  ...
  @Override public Integer visitROP_GE(WhileParser.ROP_GEContext ctx) {
    return 2;
  }

  @Override public Integer visitROP_LE(WhileParser.ROP_LEContext ctx) {
    return 3;
  }

  @Override public Integer visitROP_EQ(WhileParser.ROP_EQContext ctx) {
    return 4;
  }

  @Override public Integer visitROP_NEQ(WhileParser.ROP_NEQContext ctx) {
    return 5;
  }
  ...
  @Override public Integer visitBOP_XOR(WhileParser.BOP_XORContext ctx) {
    return 2;
  }
